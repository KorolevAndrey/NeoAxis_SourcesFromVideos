...
namespace Project
{
	public class PlayScreen : UIControl
	{
		...
		{
			//Game mode
			if( invOpen == false && gameMode != null && gameMode.ProcessInputMessage( this, new InputMessageMouseButtonDown( button ) ) )
				return true;
		...
		protected override bool OnMouseUp( EMouseButtons button )
		{
			...
			//ScreenMessages.Add("MouseUp1111");
			
			//Game mode
			if( /*invOpen == false &&*/ gameMode != null && gameMode.ProcessInputMessage( this, new InputMessageMouseButtonUp( button ) ) )
				return true;
		...
		{
			//Game mode
			if( invOpen == false && gameMode != null && gameMode.ProcessInputMessage( this, new InputMessageMouseDoubleClick( button ) ) )
				return true;
		...
		{
			//Game mode
			if( invOpen == false && gameMode != null && gameMode.ProcessInputMessage( this, new InputMessageMouseWheel( delta ) ) )
				return true;
